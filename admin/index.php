...
<div class="card" style="margin-bottom: 25px; box-shadow: none; border: 1px solid rgba(13, 92, 52, 0.1); width: 100%;">
    ...
    <p style="font-size: 14px; color: var(--text-muted); line-height: 1.6;">
        Melalui portal kontrol ini, Anda memiliki kendali penuh atas manajemen akademik dan autentikasi pengguna MI Al-Adzkiya. Silakan gunakan menu sidebar di sebelah kiri untuk memulai pengelolaan data.
    </p>
</div>
...
<div class="stat-grid">
    ...
    <div class="stat-card" style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 15px;">
        <h3 style="font-size: 12px; margin: 0 0 8px 0; color: var(--text-muted); font-weight: 600; text-transform: uppercase;">Sebaran Gender</h3>
        <div style="position: relative; height: 90px; width: 90px;">
            ...
            <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; pointer-events: none;">
                <span style="font-size: 9px; font-weight: bold; color: #3b82f6; line-height: 1.1;">L <?php echo $pct_L; ?>%</span>
                <span style="font-size: 9px; font-weight: bold; color: #ec4899; line-height: 1.1;">P <?php echo $pct_P; ?>%</span>
            </div>
        </div>
    </div>
    <div class="stat-card">
    ...
    <div class="stat-card">
        <div class="stat-info">
            ...
            <p style="font-size: 16px; margin-top: 10px; font-weight: bold; color: var(--primary-dark);"><?php echo htmlspecialchars($ta_display); ?></p>
        </div>
        <div class="stat-icon-box stat-icon-purple">
            <i class="fa-solid fa-calendar-days"></i>
        </div>
    </div>
    <div class="stat-card" style="display: flex; flex-direction: column; justify-content: center; padding: 15px 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <h3 style="font-size: 14px; margin: 0; color: var(--text-main);">Aktivitas Terbaru</h3>
            <a href="riwayat.php" style="font-size: 11px; color: var(--primary-color); text-decoration: none; font-weight: 600;">Lihat Semua</a>
        </div>
            ...
            <?php foreach ($riwayat as $log): ?>
                <div style="display: flex; flex-direction: column; gap: 4px;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <strong style="color: var(--primary-dark); font-size: 12px;"><?php echo htmlspecialchars($log['nama_lengkap'] ?? 'Sistem'); ?></strong>
                        <span style="font-size: 10px; color: var(--text-muted);"><?php echo date('d/m/Y H:i', strtotime($log['created_at'])); ?></span>
                    </div>
                    <div style="color: var(--text-muted); line-height: 1.3; font-size: 11px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<?php echo htmlspecialchars($log['aktivitas']); ?>"><?php echo htmlspecialchars($log['aktivitas']); ?></div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
    </div>
